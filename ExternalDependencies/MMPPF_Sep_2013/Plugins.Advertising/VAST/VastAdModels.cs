...
namespace Microsoft.SilverlightMediaFramework.Plugins.Advertising.VAST
{
    ...
    public class VastAdPod : AdPod
    {
        ...
        {
            AdModelFactory.AdHandler.LoadAdUnitAsync(AdUnit, success =>
            {
                if (success)
                {
                    // if ad is a wrapper, load it
                    AdModelFactory.AdHandler.UnWrapAdPod(this, () =>
                    {
    ...
    public class LinearVastCreative : VastCreative
    {
        ...
        {
            ActiveCreative = AdModelFactory.GetLinearCreative(Parent.Parent.Ad.Item as VASTADInLine, Creative, Linear, Parent.Parent.Parent.AdUnit.Source, addToTarget);
