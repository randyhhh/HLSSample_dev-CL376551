...
namespace Microsoft.SilverlightMediaFramework.Plugins.Advertising.VPAID
{
    ...
    public class VpaidController
    {
        ...
        /// </summary>
        public event EventHandler<ActiveCreativeEventArgs> AdApproachingEnd;
 ...
 bitrate,
        ...
        object CurrentlyPlayingAdContext
        {
            get
            {
                return activeAds.Keys.OfType<IVpaidSupportsPreloading>()
                    .Where(p => p.CurrentAdContext != null)
                    .Select(p => p.CurrentAdContext)
                    .FirstOrDefault();
            }
        }
 ...
 bitrate,
        ...
        void player_AdVideoThirdQuartile(object sender, EventArgs e)
        {
            ...
            if (AdApproachingEnd != null)
            {
                ...
                AdApproachingEnd(this, new ActiveCreativeEventArgs(ad, userState));
            }
        }
